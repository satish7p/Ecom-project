...
<div class="login">
  ...
  <form class="login-form">
   <form:form action="Login" commandName="Login" method="GET" onsubmit="return validate">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									 <input class="login-input" type="text" placeholder="username" path="username"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input class="login-input" type="password" placeholder="password" path="pwd"/>
						...
						<div class="form-group ">
						<form:button name="Login" button color="#0000FF"></form:button>
